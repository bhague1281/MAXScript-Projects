...
scenes using 3ds Max. In addition, commonly used settings were added for
ease of use (e.g. render a single frame/an active time segment, 
render hidden objects, force two-sided, etc.). The script will also alert
you when you are rendering in perspective mode, and a popup will appear
asking if you want to change to a camera. In order to make the code 
